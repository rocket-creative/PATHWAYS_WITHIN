...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://wellness-lac.vercel.app/services/acupuncture' },
  openGraph: {
    ...
    url: 'https://wellness-lac.vercel.app/services/acupuncture',
    type: 'website',
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', serviceType: 'Acupuncture', name: 'Acupuncture Services', description: 'Licensed acupuncture services using traditional Chinese medicine techniques for pain relief, stress management, anxiety, sleep improvement, digestive health, and hormonal balance.', url: 'https://wellness-lac.vercel.app/services/acupuncture', provider: { '@type': 'HealthAndBeautyBusiness', name: 'Pathways Within Wellness', telephone: '+1-516-336-9209', url: 'https://wellness-lac.vercel.app' } }
