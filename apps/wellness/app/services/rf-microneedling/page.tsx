...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://pathwayswellness.com/services/rf-microneedling' },
  openGraph: { title: 'RF Microneedling | Long Island | Pathways Within Wellness', description: 'Advanced RF microneedling for skin tightening and collagen stimulation.', url: 'https://pathwayswellness.com/services/rf-microneedling', type: 'website', images: [{ url: '/og-rf-microneedling.jpg', width: 1200, height: 630, alt: 'RF Microneedling' }] },
