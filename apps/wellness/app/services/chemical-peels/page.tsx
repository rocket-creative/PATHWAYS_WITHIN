...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://wellness-lac.vercel.app/services/chemical-peels' },
  openGraph: { title: 'Chemical Peels | Long Island | Pathways Within Wellness', description: 'Professional chemical peels for skin rejuvenation and texture improvement.', url: 'https://wellness-lac.vercel.app/services/chemical-peels', type: 'website', images: [{ url: '/og-chemical-peels.jpg', width: 1200, height: 630, alt: 'Chemical Peels' }] },
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', serviceType: 'Chemical Peel', name: 'Chemical Peels', description: 'Professional chemical peel treatments for skin rejuvenation, texture improvement, and brightening.', url: 'https://wellness-lac.vercel.app/services/chemical-peels', provider: { '@type': 'HealthAndBeautyBusiness', name: 'Pathways Within Wellness', telephone: '+1-516-336-9209' } }
const breadcrumbSchema = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: 'https://wellness-lac.vercel.app' }, { '@type': 'ListItem', position: 2, name: 'Services', item: 'https://wellness-lac.vercel.app/services' }, { '@type': 'ListItem', position: 3, name: 'Chemical Peels', item: 'https://wellness-lac.vercel.app/services/chemical-peels' }] }
