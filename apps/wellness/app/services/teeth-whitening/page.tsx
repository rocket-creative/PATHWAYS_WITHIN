...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://wellness-lac.vercel.app/services/teeth-whitening' },
  openGraph: { title: 'Teeth Whitening | Long Island | Pathways Within Wellness', description: 'Professional teeth whitening for a brighter smile.', url: 'https://wellness-lac.vercel.app/services/teeth-whitening', type: 'website', images: [{ url: '/og-teeth-whitening.jpg', width: 1200, height: 630, alt: 'Teeth Whitening' }] },
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', serviceType: 'Teeth Whitening', name: 'Teeth Whitening', description: 'Professional teeth whitening treatments that can brighten your smile up to 8 shades. Safe, fast, and effective.', url: 'https://wellness-lac.vercel.app/services/teeth-whitening', provider: { '@type': 'HealthAndBeautyBusiness', name: 'Pathways Within Wellness', telephone: '+1-516-336-9209' } }
const breadcrumbSchema = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: 'https://wellness-lac.vercel.app' }, { '@type': 'ListItem', position: 2, name: 'Services', item: 'https://wellness-lac.vercel.app/services' }, { '@type': 'ListItem', position: 3, name: 'Teeth Whitening', item: 'https://wellness-lac.vercel.app/services/teeth-whitening' }] }
