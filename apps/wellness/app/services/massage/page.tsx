...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://wellness-lac.vercel.app/services/massage' },
  openGraph: {
    ...
    url: 'https://wellness-lac.vercel.app/services/massage',
    type: 'website',
