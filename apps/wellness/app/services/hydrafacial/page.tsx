...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://wellness-lac.vercel.app/services/hydrafacial' },
  openGraph: {
    ...
    url: 'https://wellness-lac.vercel.app/services/hydrafacial',
    type: 'website',
