...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://pathwayswellness.com/services/facials-skincare' },
  openGraph: { title: 'Facials & Skincare | Long Island | Pathways Within Wellness', description: 'Professional facials and customized skincare treatments.', url: 'https://pathwayswellness.com/services/facials-skincare', type: 'website', images: [{ url: '/og-facials.jpg', width: 1200, height: 630, alt: 'Facials & Skincare' }] },
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', serviceType: 'Facial Treatment', name: 'Facials & Skincare', description: 'Professional facial treatments including customized facials, anti-aging treatments, acne care, and skincare consultations.', url: 'https://pathwayswellness.com/services/facials-skincare', provider: { '@type': 'HealthAndBeautyBusiness', name: 'Pathways Within Wellness', telephone: '+1-516-336-9209' } }
const breadcrumbSchema = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: 'https://pathwayswellness.com' }, { '@type': 'ListItem', position: 2, name: 'Services', item: 'https://pathwayswellness.com/services' }, { '@type': 'ListItem', position: 3, name: 'Facials & Skincare', item: 'https://pathwayswellness.com/services/facials-skincare' }] }
