...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://pathwayswellness.com/services/iv-vitamin-infusion' },
  openGraph: {
    ...
    url: 'https://pathwayswellness.com/services/iv-vitamin-infusion',
    type: 'website',
