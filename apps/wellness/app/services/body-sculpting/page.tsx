...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://wellness-lac.vercel.app/services/body-sculpting' },
  openGraph: { title: 'Body Sculpting | Long Island | Pathways Within Wellness', description: 'Non-invasive body contouring and fat reduction treatments.', url: 'https://wellness-lac.vercel.app/services/body-sculpting', type: 'website', images: [{ url: '/og-body-sculpting.jpg', width: 1200, height: 630, alt: 'Body Sculpting' }] },
