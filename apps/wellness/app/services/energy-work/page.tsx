...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://wellness-lac.vercel.app/services/energy-work' },
  openGraph: { title: 'Energy Work & Reiki | Long Island | Pathways Within Wellness', description: 'Energy healing and Reiki for balance, stress relief, and natural wellness.', url: 'https://wellness-lac.vercel.app/services/energy-work', type: 'website', images: [{ url: '/og-energy-work.jpg', width: 1200, height: 630, alt: 'Energy Work & Reiki' }] },
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', serviceType: 'Energy Healing', name: 'Energy Work & Reiki', description: 'Energy healing and Reiki sessions for balancing energy, stress relief, and promoting natural healing processes.', url: 'https://wellness-lac.vercel.app/services/energy-work', provider: { '@type': 'HealthAndBeautyBusiness', name: 'Pathways Within Wellness', telephone: '+1-516-336-9209' } }
const breadcrumbSchema = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: 'https://wellness-lac.vercel.app' }, { '@type': 'ListItem', position: 2, name: 'Services', item: 'https://wellness-lac.vercel.app/services' }, { '@type': 'ListItem', position: 3, name: 'Energy Work', item: 'https://wellness-lac.vercel.app/services/energy-work' }] }
