...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://wellness-lac.vercel.app/services/permanent-makeup' },
  openGraph: { title: 'Permanent Makeup | Long Island | Pathways Within Wellness', description: 'Microblading, lip blush, and permanent cosmetics.', url: 'https://wellness-lac.vercel.app/services/permanent-makeup', type: 'website', images: [{ url: '/og-permanent-makeup.jpg', width: 1200, height: 630, alt: 'Permanent Makeup' }] },
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', serviceType: 'Permanent Makeup', name: 'Permanent Makeup', description: 'Permanent makeup services including microblading, lip blush, eyeliner, and brow enhancement by skilled artists.', url: 'https://wellness-lac.vercel.app/services/permanent-makeup', provider: { '@type': 'HealthAndBeautyBusiness', name: 'Pathways Within Wellness', telephone: '+1-516-336-9209' } }
const breadcrumbSchema = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: 'https://wellness-lac.vercel.app' }, { '@type': 'ListItem', position: 2, name: 'Services', item: 'https://wellness-lac.vercel.app/services' }, { '@type': 'ListItem', position: 3, name: 'Permanent Makeup', item: 'https://wellness-lac.vercel.app/services/permanent-makeup' }] }
