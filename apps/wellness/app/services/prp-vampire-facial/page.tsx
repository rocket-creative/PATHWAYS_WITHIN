...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://wellness-lac.vercel.app/services/prp-vampire-facial' },
  openGraph: { title: 'PRP Vampire Facial | Long Island | Pathways Within Wellness', description: 'Natural skin rejuvenation with PRP therapy.', url: 'https://wellness-lac.vercel.app/services/prp-vampire-facial', type: 'website', images: [{ url: '/og-prp-facial.jpg', width: 1200, height: 630, alt: 'PRP Vampire Facial' }] },
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', serviceType: 'PRP Facial', name: 'PRP Vampire Facial', description: 'PRP Vampire Facial using platelet-rich plasma for natural skin rejuvenation, collagen stimulation, and anti-aging.', url: 'https://wellness-lac.vercel.app/services/prp-vampire-facial', provider: { '@type': 'HealthAndBeautyBusiness', name: 'Pathways Within Wellness', telephone: '+1-516-336-9209' } }
const breadcrumbSchema = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: 'https://wellness-lac.vercel.app' }, { '@type': 'ListItem', position: 2, name: 'Services', item: 'https://wellness-lac.vercel.app/services' }, { '@type': 'ListItem', position: 3, name: 'PRP Vampire Facial', item: 'https://wellness-lac.vercel.app/services/prp-vampire-facial' }] }
