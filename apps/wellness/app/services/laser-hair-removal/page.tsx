...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://pathwayswellness.com/services/laser-hair-removal' },
  openGraph: { title: 'Laser Hair Removal | Long Island | Pathways Within Wellness', description: 'Safe and effective laser hair removal for permanent reduction.', url: 'https://pathwayswellness.com/services/laser-hair-removal', type: 'website', images: [{ url: '/og-laser-hair.jpg', width: 1200, height: 630, alt: 'Laser Hair Removal' }] },
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'Service', serviceType: 'Laser Hair Removal', name: 'Laser Hair Removal', description: 'Safe, effective laser hair removal treatments for permanent hair reduction on all skin types.', url: 'https://pathwayswellness.com/services/laser-hair-removal', provider: { '@type': 'HealthAndBeautyBusiness', name: 'Pathways Within Wellness', telephone: '+1-516-336-9209' } }
const breadcrumbSchema = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: 'https://pathwayswellness.com' }, { '@type': 'ListItem', position: 2, name: 'Services', item: 'https://pathwayswellness.com/services' }, { '@type': 'ListItem', position: 3, name: 'Laser Hair Removal', item: 'https://pathwayswellness.com/services/laser-hair-removal' }] }
