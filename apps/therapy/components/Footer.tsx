        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-slate-400 font-body">
              ...
              <li><Link href="/services/child-therapy" className="hover:text-white">Child & Teen</Link></li>
              <li><Link href="/services" className="hover:text-white text-therapy">All Therapy Services →</Link></li>
            </ul>
          </div>
