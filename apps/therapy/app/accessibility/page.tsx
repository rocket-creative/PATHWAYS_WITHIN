...
export const metadata: Metadata = {
  ...
  description: 'Accessibility Statement for Pathways Within Therapy. Our commitment to digital accessibility.',
}
          ...
          <div className="prose prose-slate max-w-none font-body">
            <section className="bg-white rounded-xl p-6 mb-6 border border-slate-200">
              ...
              <p className="text-slate-600">
                Pathways Within Therapy is committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone and applying the relevant accessibility standards.
              </p>
            </section>
            ...
            <section className="bg-white rounded-xl p-6 mb-6 border border-slate-200">
              ...
              <ul className="text-slate-600">
                ...
                <li><strong>ARIA labels</strong> - Screen reader friendly navigation and buttons</li>
              </ul>
            </section>

            <section className="bg-white rounded-xl p-6 mb-6 border border-slate-200">
              <h2 className="font-title font-semibold text-xl text-slate-800 mt-0">Browser Compatibility</h2>
              <p className="text-slate-600">
            ...
            <section className="bg-white rounded-xl p-6 mb-6 border border-slate-200">
              ...
              <p className="text-slate-600">
                Our physical office locations are committed to accessibility. If you have specific accessibility needs for in-person visits, please contact us in advance so we can accommodate you.
              </p>
            </section>
            ...
            <section className="bg-white rounded-xl p-6 mb-6 border border-slate-200">
              ...
              <p className="text-slate-600">
                <strong>Phone:</strong> (631) 371-3825<br />
                <strong>Email:</strong> Welcome@pathwayswithin.com
              </p>
              <p className="text-slate-600">
