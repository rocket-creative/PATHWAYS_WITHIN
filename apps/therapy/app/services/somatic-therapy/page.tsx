...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://pathwayswithintherapy.com/services/somatic-therapy' },
  openGraph: {
    ...
    url: 'https://pathwayswithintherapy.com/services/somatic-therapy',
    type: 'website',
...
const serviceSchema = { '@context': 'https://schema.org', '@type': 'MedicalTherapy', name: 'Somatic Therapy', description: 'Body-centered therapeutic approach that addresses trauma and stress stored in the body through techniques like body awareness, tension release, and nervous system regulation.', url: 'https://pathwayswithintherapy.com/services/somatic-therapy', provider: { '@type': 'MedicalBusiness', name: 'Pathways Within Therapy', telephone: '+1-631-371-3825', url: 'https://pathwayswithintherapy.com' }, medicalSpecialty: 'Psychiatry' }
