...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://pathways-therapy.vercel.app/services/hypnotherapy' },
  openGraph: {
    ...
    url: 'https://pathways-therapy.vercel.app/services/hypnotherapy',
    type: 'website',
