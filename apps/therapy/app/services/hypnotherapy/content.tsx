...
export default function HypnotherapyContent() {
  return (
    <>
      ...
      <main id="main">
        <section className="bg-white py-16 md:py-20" aria-labelledby="page-title">
          <div className="max-w-site mx-auto px-6 lg:px-12">
            <nav className="text-sm text-slate-500 font-body mb-6" aria-label="Breadcrumb"><Link href="/services" className="hover:text-therapy">Services</Link><span className="mx-2">/</span><span className="text-slate-800">Hypnotherapy</span></nav>
            <div className="max-w-3xl">
              <h1 id="page-title" className="font-title font-bold text-4xl md:text-5xl text-slate-800 mb-4">Hypnotherapy</h1>
              <p className="text-xl text-slate-600 font-body">Clinical Hypnosis for Positive Change</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-ivory py-16" aria-labelledby="what-is-section">
          <div className="max-w-site mx-auto px-6 lg:px-12">
            <div className="max-w-3xl">
              <h2 id="what-is-section" className="font-title font-semibold text-2xl text-slate-800 mb-4">What is Hypnotherapy?</h2>
              <p className="text-slate-600 font-body mb-4">Hypnotherapy uses guided relaxation and focused attention to achieve a heightened state of awareness, sometimes called a trance. In this state, you can explore thoughts, feelings, and memories that may be hidden from your conscious mind.</p>
              <div className="bg-therapy/5 rounded-xl p-6 border border-therapy/20">
                <h3 className="font-title font-medium text-therapy mb-2">Important Note</h3>
                <p className="text-slate-600 font-body text-sm">Clinical hypnotherapy is not stage hypnosis. You remain in control throughout and cannot be made to do anything against your will. It&apos;s a therapeutic tool, not entertainment.</p>
              </div>
            </div>
          </div>
        </section>

        <section className="bg-white py-16" aria-labelledby="helps-with-section">
          <div className="max-w-site mx-auto px-6 lg:px-12">
            <h2 id="helps-with-section" className="font-title font-semibold text-2xl text-slate-800 mb-8 text-center">What Hypnotherapy Can Help With</h2>
            <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
              {['Anxiety & Stress', 'Habit Change (Smoking)', 'Weight Management', 'Phobias & Fears', 'Sleep Improvement', 'Performance Enhancement', 'Pain Management', 'Confidence Building', 'Trauma Processing'].map((item, i) => (
        ...
        <section className="bg-therapy py-16" aria-labelledby="cta-section">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <h2 id="cta-section" className="font-title font-bold text-3xl text-white mb-3">Curious About Hypnotherapy?</h2>
            <p className="text-white/80 font-body mb-6">Contact us to learn if hypnotherapy might help you.</p>
