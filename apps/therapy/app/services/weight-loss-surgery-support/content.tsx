...
export default function WeightLossSurgerySupportContent() {
  return (
    <>
      ...
      <main id="main">
        <section className="bg-white py-16 md:py-20" aria-labelledby="page-title">
          <div className="max-w-site mx-auto px-6 lg:px-12">
            <nav className="text-sm text-slate-500 font-body mb-6" aria-label="Breadcrumb"><Link href="/services" className="hover:text-therapy">Services</Link><span className="mx-2">/</span><span className="text-slate-800">Weight Loss Surgery Support</span></nav>
            <div className="max-w-3xl">
              <h1 id="page-title" className="font-title font-bold text-4xl md:text-5xl text-slate-800 mb-4">Weight Loss Surgery Support</h1>
              <p className="text-xl text-slate-600 font-body">Pre-Surgical Evaluations & Ongoing Counseling</p>
            </div>
          </div>
        </section>

        <section className="bg-ivory py-16" aria-labelledby="comprehensive-section">
          <div className="max-w-site mx-auto px-6 lg:px-12">
            <div className="max-w-3xl">
              <h2 id="comprehensive-section" className="font-title font-semibold text-2xl text-slate-800 mb-4">Comprehensive Bariatric Support</h2>
              <p className="text-slate-600 font-body mb-4">Weight loss surgery is a significant decision that involves not just physical changes but emotional and psychological ones as well. We provide comprehensive support throughout your journey.</p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4 border border-slate-200">
                  <h3 className="font-title font-medium text-therapy mb-2">Pre-Surgical</h3>
                ...
                <div className="bg-white rounded-lg p-4 border border-slate-200">
                  <h3 className="font-title font-medium text-therapy mb-2">Post-Surgical</h3>
                  <ul className="text-slate-600 text-sm font-body space-y-1">
                    <li>• Emotional adjustment support</li>
                    <li>• Relationship changes</li>
                    <li>• Body image work</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <section className="bg-white py-16" aria-labelledby="address-section">
          <div className="max-w-site mx-auto px-6 lg:px-12">
            <h2 id="address-section" className="font-title font-semibold text-2xl text-slate-800 mb-8 text-center">What We Address</h2>
            <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
              {['Emotional Eating Patterns', 'Body Image Concerns', 'Relationship with Food', 'Identity Changes', 'Anxiety About Surgery', 'Life After Surgery', 'Support System Building', 'Long-Term Success Strategies', 'Relapse Prevention'].map((item, i) => (
                <div key={i} className="bg-ivory rounded-lg p-4 text-center border border-slate-200"><span className="text-slate-700 font-body text-sm">{item}</span></div>
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="bg-therapy py-16" aria-labelledby="cta-section">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <h2 id="cta-section" className="font-title font-bold text-3xl text-white mb-3">Preparing for Your Surgery?</h2>
            <p className="text-white/80 font-body mb-6">We can help with evaluations and ongoing support.</p>
