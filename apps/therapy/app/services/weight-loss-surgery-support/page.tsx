...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://pathwayswithintherapy.com/services/weight-loss-surgery-support' },
  openGraph: {
    ...
    url: 'https://pathwayswithintherapy.com/services/weight-loss-surgery-support',
    type: 'website',
