...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://pathwayswithintherapy.com/services/veterans-first-responders' },
  openGraph: {
    title: 'Veterans & First Responders Therapy | Pathways Within',
    description: 'Specialized therapy for military veterans, police, firefighters, and EMTs. VA Community Care accepted.',
    url: 'https://pathwayswithintherapy.com/services/veterans-first-responders',
    type: 'website',
